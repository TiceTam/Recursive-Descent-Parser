...
typedef struct {
  char identifier[IDENT_LENMAX]; // identsym
...
//function takes in symbol table and current symbol, then iterates through the entire symbol table to see if it has been declared
